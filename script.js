...
img1.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img1.setAttribute('src', 'images/expertise/1(1).png');
...
img1.addEventListener('mouseleave', () => {
    img1.style.opacity = '0';
    setTimeout(() => {
        img1.setAttribute('src', 'images/expertise/1.png');
        img1.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img2.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img2.setAttribute('src', 'images/expertise/2(1).png');
...
img2.addEventListener('mouseleave', () => {
    img2.style.opacity = '0';
    setTimeout(() => {
        img2.setAttribute('src', 'images/expertise/2.png');
        img2.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img3.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img3.setAttribute('src', 'images/expertise/3(1).png');
...
img3.addEventListener('mouseleave', () => {
    img3.style.opacity = '0';
    setTimeout(() => {
        img3.setAttribute('src', 'images/expertise/3.png');
        img3.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img4.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img4.setAttribute('src', 'images/expertise/4(1).png');
...
img4.addEventListener('mouseleave', () => {
    img4.style.opacity = '0';
    setTimeout(() => {
        img4.setAttribute('src', 'images/expertise/4.png');
        img4.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img5.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img5.setAttribute('src', 'images/expertise/5(1).png');
...
img5.addEventListener('mouseleave', () => {
    img5.style.opacity = '0';
    setTimeout(() => {
        img5.setAttribute('src', 'images/expertise/5.png');
        img5.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img6.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img6.setAttribute('src', 'images/expertise/6(1).png');
...
img6.addEventListener('mouseleave', () => {
    img6.style.opacity = '0';
    setTimeout(() => {
        img6.setAttribute('src', 'images/expertise/6.png');
        img6.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img7.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img7.setAttribute('src', 'images/expertise/7(1).png');
...
img7.addEventListener('mouseleave', () => {
    img7.style.opacity = '0';
    setTimeout(() => {
        img7.setAttribute('src', 'images/expertise/7.png');
        img7.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img8.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img8.setAttribute('src', 'images/expertise/8(1).png');
...
img8.addEventListener('mouseleave', () => {
    img8.style.opacity = '0';
    setTimeout(() => {
        img8.setAttribute('src', 'images/expertise/8.png');
        img8.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img9.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img9.setAttribute('src', 'images/expertise/9(1).png');
...
img9.addEventListener('mouseleave', () => {
    img9.style.opacity = '0';
    setTimeout(() => {
        img9.setAttribute('src', 'images/expertise/9.png');
        img9.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img10.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img10.setAttribute('src', 'images/expertise/10(1).png');
...
img10.addEventListener('mouseleave', () => {
    img10.style.opacity = '0';
    setTimeout(() => {
        img10.setAttribute('src', 'images/expertise/10.png');
        img10.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img11.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img11.setAttribute('src', 'images/expertise/11(1).png');
...
img11.addEventListener('mouseleave', () => {
    img11.style.opacity = '0';
    setTimeout(() => {
        img11.setAttribute('src', 'images/expertise/11.png');
        img11.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
...
img12.addEventListener('mouseenter', () => {
    ...
    setTimeout(() => {
        img12.setAttribute('src', 'images/expertise/12(1).png');
...
img12.addEventListener('mouseleave', () => {
    img12.style.opacity = '0';
    setTimeout(() => {
        img12.setAttribute('src', 'images/expertise/12.png');
        img12.style.opacity = '1';
    }, 170); // Adjust timing as needed
});
